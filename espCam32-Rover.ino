const char* ssid = "kerenCas";
const char* password = "KSCV1234";
...
IPAddress staticIP(192, 168, 4, 1); // Set your desired IP address
IPAddress gateway(192, 168, 4, 1); // Set your gateway IP
...
void setup(){
  ...
  if (apIP != IPAddress(0, 0, 0, 0)) {
    Serial.println("Wi-Fi AP is active");
    Serial.print("AP IP address: ");
    Serial.println(apIP);
  } else {
    Serial.println("Wi-Fi AP not active");
  }
